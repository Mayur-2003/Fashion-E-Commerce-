                      ...
                      <>
                        <h3 className="-my-3 flow-root">
                          <DisclosureButton className="flex w-full items-center justify-between bg-white py-3 text-sm text-gray-400 hover:text-gray-500">
                            <span className=" text-[#1A2130] font-medium text-[14px]">{section.name}</span>
                            <span className="ml-6 flex items-center">
                              {open ? (
                                <MinusIcon className="h-5 w-5" aria-hidden="true" />
                              ) : (
                    ...
                    {({ open }) => (
                      <>
                        <h3 className="-my-3 flow-root">
                          ...
                          <DisclosureButton className="flex w-full items-center justify-between bg-white py-3 text-sm text-gray-400 hover:text-gray-500">
                            {/* <span className=" text-black font-medium text-[14px]"></span> */}

                            <FormLabel id="demo-radio-buttons-group-label" sx={{color:"#000", fontSize:"14px", fontWeight:"400"}}>{section.name}</FormLabel>
                            <span className="ml-6 flex items-center">
                              {open ? (
                                <MinusIcon className="h-5 w-5" aria-hidden="true" />
                              ) : (
